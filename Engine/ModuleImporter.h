...
public:
	...
	GameObject* ProcessNode(const aiNode* node, const aiScene* scene, GameObject* obj, const char* file);
	GameObject* ProcessNode(const aiNode* node, const aiScene* scene, GameObject* obj, std::vector<ReImport>& resourcesToReimport, std::string path);
	void ProcessTransform(const aiNode* node, CompTransform* trans);
