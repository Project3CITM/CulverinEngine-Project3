...
public class CloseDoor_EnemyDead : CulverinBehaviour
{
    ...
    void Update()
    {
        ...
        if (temp_bt_sw != null)
        {
            if(temp_bt_sw.life_state == Enemy_BT.ENEMY_STATE.ENEMY_DEAD)
            {
                go_open = true;
                enemy_is_dead = true;
            }
        ...
        {
            if (temp_bt_sp.life_state == Enemy_BT.ENEMY_STATE.ENEMY_DEAD)
            {
                go_open = true;
                enemy_is_dead = true;
            }
        ...
        {
            if (temp_bt_sh.life_state == Enemy_BT.ENEMY_STATE.ENEMY_DEAD)
            {
                go_open = true;
                enemy_is_dead = true;
            }
