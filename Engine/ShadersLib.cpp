...
#pragma comment (lib, "GL3W/libx86/glew32.lib") 
	...
	ShaderProgram* ShaderManager::CreateShader(char* name)
	{
	...
	ShaderProgram * ShaderManager::CreateDefaultShader()
	{
	...
	Shader* ShaderManager::CompileShader(std::string path, ShaderType type)
	{
		uint id = 0;
		switch (type) {
		case fragment:
	...
	void ShaderManager::AddShaderList(Shader* newShader)
	{
